...
var config = {
	...
	entry:  path.resolve(__dirname,"src/template/js/template.js"),
	output: {
	...
	*/
	devServer:{
		contentBase: path.join(__dirname, "src/template/build/"),
		compress: true,
		port: 9000,
	...
	plugins: [
		...
		new ExtractTextPlugin("[name]-[hash:5].css"), // 输出独立css文件
