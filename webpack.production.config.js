...
*/
var config = {
	context: path.resolve(__dirname,"src/template/20170505/page-1/"),
	entry:  path.resolve(__dirname,"src/template/20170505/page-1/js/template.js"),
	output: {
		path: path.resolve(__dirname,"src/builds/dist/"),
